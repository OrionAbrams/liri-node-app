# liri-node-app
liri- my first terminal app.

# Instructions to Use

You must remove the ".example" from the ".env.example" file and use your own keys for OMDB, Spotify, and Bands in Town. You must also have npm and "npm i" in the terminal to install the required packages.
...
In the terminal, write "liri.js" followed by the following terms:
   ...
   * `do-what-it-says`
   ...
   Youtube URL for instructions and walkthrough of the program:
